    ...
    <section id="section">
      <aside>
        <p>
          ...
          for sending a little love/credit to that special someone who helped
          fix that gnarly bug of yours. See the attribution on the history page,
          undo an accidental attribution, and{' '}
      ...
      <aside>
        <p>
          ...
          See all open pull requests for your repositories and check them out as
          if they were a local branch, even if they&apos;re from upstream
          branches or forks. See which pull requests pass commit status checks,
          too!
        </p>
        <img
          id="pr"
      ...
      <aside>
        <p>
          ...
          highlighting when viewing diffs for a variety of different languages.
        </p>
        <img
          id="code"
          src={code}
